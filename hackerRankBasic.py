...
def choosing_article(*words):
    ...
    """
    if len(words) == 1:
        if words[0] in dictionary_letters['vowels']:
            return f'an {words}'
        else: 
            return f'a {words}'
    else:
...
print(choosing_article('huge', 'yellow', 'cat'))

def choosing_article_1(*words):
...
print(choosing_article_1('huge', 'yellow', 'love'))
...
print(choosing_article_2(size_adjective1, color_adjective1, noun3))